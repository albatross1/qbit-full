...
RUN useradd -m -d /qbittorrent qbittorrent && \
    ...
    chown 1000:1000 /Downloads/temp && \
    chown 1000:1000 /qbittorrent && \
    chown 1000:1000 /qbittorrent/.config && \
    chown 1000:1000 /qbittorrent/.config/qBittorrent && \
    chmod 2777 -R /Downloads && \
